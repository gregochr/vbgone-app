...
class CostServiceTest {
    ...
    @Test
    void calculateCost_copilotGpt4oUsesPlaceholderPricing() {
        // PLACEHOLDER pricing: openai/gpt-4o $2.5 input, $10 output per million
        double cost = CostService.calculateCost("openai/gpt-4o", 1_000_000, 0);
        assertThat(cost).isEqualTo(2.5);
    }
